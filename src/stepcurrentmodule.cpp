...
/*
 * There are three scenarios, in which stepcurrentmodule can be loaded by NEST:
 *
...
stepcurrentmodule::StepCurrentModule stepcurrentmodule_LTX_mod;
#endif
// -- DynModule functions ------------------------------------------------------

stepcurrentmodule::StepCurrentModule::StepCurrentModule()
{
#ifdef LINKED_MODULE
...
stepcurrentmodule::StepCurrentModule::~StepCurrentModule() = default;

const std::string
stepcurrentmodule::StepCurrentModule::name() const
{
  return std::string( "Step Current Module" ); // Return name of the module
}

//-------------------------------------------------------------------------------------

void
stepcurrentmodule::StepCurrentModule::init( SLIInterpreter* i )
{
