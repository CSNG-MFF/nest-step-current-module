...
#ifndef AEIF_COND_EXP_SC_H
#define AEIF_COND_EXP_SC_H
 ...
 */
extern "C" int aeif_cond_exp_sc_dynamics( double, const double*, double*, void* );
 ...
 * @param void* Pointer to model neuron instance.
 */
extern "C" int aeif_cond_exp_sc_dynamics_DT0( double, const double*, double*, void* );
...
iaf_cond_exp_sc, aeif_cond_alpha
...
class aeif_cond_exp_sc : public nest::ArchivingNode
{

public:
  aeif_cond_exp_sc();
  aeif_cond_exp_sc( const aeif_cond_exp_sc& );
  ~aeif_cond_exp_sc();
...
private:
  ...
  friend int aeif_cond_exp_sc_dynamics( double, const double*, double*, void* );

  // The next two classes need to be friends to access the State_ class/member
  friend class RecordablesMap< aeif_cond_exp_sc >;
  friend class UniversalDataLogger< aeif_cond_exp_sc >;
...
public:
  ...
  struct Buffers_
  {
    Buffers_( aeif_cond_exp_sc& );                  //!< Sets buffer pointers to 0
    Buffers_( const Buffers_&, aeif_cond_exp_sc& ); //!< Sets buffer pointers to 0

    //! Logger for all analog data
    UniversalDataLogger< aeif_cond_exp_sc > logger_;
  ...
  static RecordablesMap< aeif_cond_exp_sc > recordablesMap_;
};

inline port
aeif_cond_exp_sc::send_test_event( Node& target, rport receptor_type, synindex, bool )
{
  SpikeEvent e;
  e.set_sender( *this );
...
inline port
aeif_cond_exp_sc::handles_test_event( SpikeEvent&, rport receptor_type )
{
  if ( receptor_type != 0 )
  {
...
inline port
aeif_cond_exp_sc::handles_test_event( CurrentEvent&, rport receptor_type )
{
  if ( receptor_type != 0 )
  {
    throw UnknownReceptorType( receptor_type, get_name() );
...
inline port
aeif_cond_exp_sc::handles_test_event( DataLoggingRequest& dlr, rport receptor_type )
{
  if ( receptor_type != 0 )
  {
    throw UnknownReceptorType( receptor_type, get_name() );
...
inline void
aeif_cond_exp_sc::get_status( DictionaryDatum& d ) const
{
  P_.get( d );
  S_.get( d );
